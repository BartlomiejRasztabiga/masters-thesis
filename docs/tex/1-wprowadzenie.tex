...
\begin{itemize}
    ...
    \item \textbf{Rozdział 5 – Wyniki eksperymentów}: szczegółowa prezentacja wyników dla każdej z pięciu hipotez, analiza danych oraz synteza wyników z wnioskami i implikacjami praktycznymi,
