...
\begin{itemize}
    \item \textbf{Bezpośrednie API:} W przypadku modeli komercyjnych, które oferują własne dedykowane API (np. OpenAI GPT-5 Mini, Google Gemini 2.5 Flash, Anthropic Claude), korzystano z ich natywnych interfejsów programistycznych.
