...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Porównanie modeli w przekroju RQ1--RQ5 ($^*$~RQ4 przeprowadzono tylko dla modeli Gemini i DeepSeek)}
...
Zagrożenia ważności eksperymentów zostały zidentyfikowane a priori w rozdziale~4 (\ref{sec:threats-to-validity}). W świetle uzyskanych wyników można ocenić, które z nich faktycznie zmaterializowały się i z jaką siłą.
