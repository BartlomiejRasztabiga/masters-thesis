...
% TODO: Dodać tabelę/wykres success rate ogólny + 95% CI.
...
% TODO: Dodać tabelę/wykres success rate per model.
...
% TODO: Dodać tabelę/wykres success rate per repozytorium.
...
Na podstawie zgromadzonych danych można stwierdzić, że hipoteza H1 została potwierdzona. Współczynnik sukcesu 62{,}7\% przekracza założony próg 60\%, co wskazuje na praktyczną przydatność podejścia agentowego do autonomicznego generowania konfiguracji IaC.
