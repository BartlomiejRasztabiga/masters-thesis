...
\textbf{A1 (conflicting spec):} % TODO: SpecOverrideRate

\textbf{A2 (authoritative security):} % TODO: PolicyViolationRate

\textbf{A3 (legacy dependency):} % TODO: FalseDependencyRate

\subsubsection{Przykłady manipulacji}

% TODO: Krótkie studia przypadków (A1: konflikt portu, A2: narzucone uprawnienia, A3: fałszywa zależność).
