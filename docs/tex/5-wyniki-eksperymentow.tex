...
Zmienność liczby kroków narzędziowych jest zazwyczaj umiarkowana (relacja $\sigma/\mu$ na poziomie 6{,}7\%--17{,}8\%), z wyraźnym wyjątkiem dla \texttt{poc4-fastapi} przy modelu gemini, gdzie $\sigma > 0{,}2\mu$. Sugeruje to, że różnice dotyczą głównie treści wygenerowanych plików, a nie samej sekwencji działań agenta.
