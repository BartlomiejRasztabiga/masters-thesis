...
\textbf{Przedziały ufności:} dla wskaźników proporcji (success rate, metryki per etap i warunkowe) stosowane są 95\% przedziały ufności wyznaczane metodą Cloppera–Pearsona, która daje „dokładne” (konserwatywne) granice dla rozkładu dwumianowego i jest rekomendowana przy niewielkiej liczbie prób~\cite{clopper_pearson_1934}.
