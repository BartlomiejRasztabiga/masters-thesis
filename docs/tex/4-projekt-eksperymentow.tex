...
\begin{itemize}
    ...
    \item \textbf{Ograniczona liczba powtórzeń}: liczba powtórzeń w eksperymentach była niewielka (zwykle 1--3 przebiegi na kombinację repozytorium, modelu i prompta), co prowadzi do szerokich przedziałów ufności i ogranicza precyzję wnioskowania.
