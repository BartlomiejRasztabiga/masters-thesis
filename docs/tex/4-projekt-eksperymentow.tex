...
\textbf{Przedziały ufności:} dla wskaźników proporcji (success rate, metryki per etap i warunkowe) stosowane są 95\% przedziały ufności wyznaczane metodą Clopper–Pearsona, co jest konserwatywnym podejściem dla niewielkiej liczby prób. % TODO znalezc paper ze metoda CP jest dobra
