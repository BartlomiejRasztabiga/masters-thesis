...
\begin{frame}{RQ1 --- Skuteczność end-to-end}
    \begin{columns}[T]
        ...
        \begin{itemize}
            ...
            \item Dominują błędy \textbf{semantyczne} --- niewidoczne dla walidacji statycznej
            \item Typowe: błędne zm. środowiskowe DB, niezgodne wersje środowiska, \texttt{runAsNonRoot} przy obrazie root
