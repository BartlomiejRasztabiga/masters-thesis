...
- **Rozdział 4 – Projekt eksperymentów (`tex/4-projekt-eksperymentow.tex`)**: metodologia i weryfikacja opisana szczegółowo dla H1; hipotezy H1–H5 zdefiniowane, a sekcje H2–H5 do uzupełnienia w kolejnej iteracji.
