...
- **Rozdział 5 – Wyniki eksperymentów (`tex/5-wyniki-eksperymentow.tex`)**: wyniki per hipoteza, statystyki, walidacja (automatyczna, LLM-as-a-Judge, ekspercka); uzupełniono listę typowych problemów w H2, wyniki H3 (tabela i wniosek) oraz H4 (powtarzalność, wnioski), dalej dodać wykresy/tabele i podsumowanie rozdziału.
